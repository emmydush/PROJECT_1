...
urlpatterns = [
    ...
    path('pos/automatic-scanner-test/', views.automatic_scanner_test_view, name='automatic_scanner_test'),
    path('pos/simple-camera-test/', views.simple_camera_test_view, name='simple_camera_test'),
    path('pos/scanner-diagnostics/', views.scanner_diagnostics_view, name='scanner_diagnostics'),
    ...
    path('cart/process/', cart_views.process_sale_from_cart, name='process_sale_from_cart'),
    path('pos/test/', views.pos_test, name='pos_test'),
]