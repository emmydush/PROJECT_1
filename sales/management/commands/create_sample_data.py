...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not products:
            self.stdout.write(self.style.ERROR('No products found. Please create products first using "python manage.py create_test_data"'))
            return
        ...
        if not customers:
            ...
            customer_names = [
                ...
                ('James', 'Moore'), ('Jennifer', 'Taylor'), ('William', 'Anderson'), ('Patricia', 'Thomas'),
                ('Richard', 'Jackson'), ('Linda', 'White'), ('Charles', 'Harris'), ('Barbara', 'Martin'),
                ('Joseph', 'Thompson'), ('Elizabeth', 'Garcia'), ('Thomas', 'Martinez'), ('Susan', 'Robinson')
            ]
        ...
        for i in range(100):
            ...
            sale.total_amount = sale_subtotal  # Not including tax/discount in this sample
            sale.save()
