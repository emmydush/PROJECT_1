...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if products_needed > 0:
            product_names = [
                'Wireless Headphones', 'Smart Watch', 'Bluetooth Speaker', 'Tablet', 'Laptop',
                'Gaming Console', 'Digital Camera', 'Fitness Tracker', 'Smart TV', 'Printer',
                'Desk Lamp', 'Office Chair', 'Backpack', 'Water Bottle', 'Sunglasses',
                'Running Shoes', 'Yoga Mat', 'Dumbbells', 'Tent', 'Sleeping Bag',
                'Skincare Set', 'Shampoo', 'Body Lotion', 'Perfume', 'Makeup Kit',
            ...
            adjectives = ['Premium', 'Deluxe', 'Standard', 'Basic', 'Professional', 'Advanced']
        ...
        if suppliers_needed > 0:
            supplier_names = [
                'Global Electronics Distributors', 'Fashion World Ltd', 'Food Services Inc',
                'Home Improvement Supplies', 'Sports Gear Co', 'Beauty Products LLC',
                'Toy Manufacturers Group', 'Auto Parts Warehouse', 'Health & Wellness Co',
                'Office Supply Central'
            ]
            
            supplier_domains = [
                'globalelectronics.com', 'fashionworld.com', 'foodservices.com',
                'homeimprovement.com', 'sportsgear.com', 'beautyproducts.com',
                'toymfg.com', 'autoparts.com', 'healthwellness.com', 'officesupply.com'
            ]
        ...
        if sales_needed > 0:
            ...
            if all_customers and all_products:
                ...
                for i in range(sales_needed):
                    ...
                    self.stdout.write(f'Created sale: {sale} with {len(selected_products)} items')
