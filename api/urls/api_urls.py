...
from api.views.main_views import (
    ...
    SaleListView, SaleDetailView, SaleCreateView,
    dashboard_stats
)
...
urlpatterns = [
    ...
    path('products/<int:pk>/update/', ProductUpdateView.as_view(), name='api_product_update'),
    path('products/<int:pk>/delete/', ProductDeleteView.as_view(), name='api_product_delete'),
