...
class ProductCreateUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        fields = [
            'name', 'sku', 'barcode', 'category', 'unit', 'supplier',
            'quantity', 'cost_price', 'selling_price', 'reorder_level',
            'expiry_date', 'description', 'is_active'
        ]
...
class ProductListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = [
            'id', 'name', 'sku', 'category_name', 'unit_name', 'unit_symbol',
            'quantity', 'cost_price', 'selling_price', 'profit_per_unit',
