...
def unread_notifications(request):
    ...
    unread_notifications = Notification.objects.filter(**notification_filter).order_by('-created_at')[:5]  # Limit to 5 most recent
    ...
    for notification in unread_notifications:
        notifications_data.append({
            ...
            'time_since': timesince(notification.created_at) if notification.created_at else 'Unknown time'
        })
